# 1 "C:/Users/david/DavidU/ElectronicaDigital2/Librerias/conf16f887.X/Timer1Configuration.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "C:/Users/david/DavidU/ElectronicaDigital2/Librerias/conf16f887.X/Timer1Configuration.c" 2
...
# 9 "C:/Users/david/DavidU/ElectronicaDigital2/Librerias/conf16f887.X/Timer1Configuration.c" 2
...
# 10 "C:/Users/david/DavidU/ElectronicaDigital2/Librerias/conf16f887.X/Timer1Configuration.c" 2


void setupTimer1(uint8_t clkSrc, uint8_t prescaler, int carga){
    T1CONbits.TMR1CS=clkSrc;
    T1CONbits.T1CKPS=prescaler;
    T1CONbits.TMR1ON=1;
    uint8_t T1L = carga & 0xFF;
    uint8_t T1H = carga>>8;
    TMR1H = T1H;
    TMR1L = T1L;
    PIR1bits.TMR1IF=0;
}
void resTimer1(int carga){
    uint8_t T1L = carga & 0xFF;
    uint8_t T1H = carga>>8;
    TMR1H = T1H;
    TMR1L = T1L;
